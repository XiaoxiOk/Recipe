...
Page({
    ...
    setUserInfo() {
        ...
        console.log('添加的用户信息：', registLoginBO)
        var ths = this
        var params = {
            url: '/user/registerAndLogin?mobile=' + ths.data.mobile,
            method: "POST",
            data: registLoginBO,
    ...
    onLoad(options) {
        ...
        console.log('register-mobile:', this.data.mobile, ";length:", this.data.mobile.length)
    },
