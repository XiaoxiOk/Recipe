...
public class GraceJSONResult {
     ...
     * @return
     */
    public static GraceJSONResult notifyMsg(String msg) {
        return new GraceJSONResult(ResponseStatusEnum.FAILED_NOTIFY, msg);
    }
     ...
     * @return
     */
    public static GraceJSONResult loginFailedMsg(String msg) {
        return new GraceJSONResult(ResponseStatusEnum.LOGIN_FAILED, msg);
    }
