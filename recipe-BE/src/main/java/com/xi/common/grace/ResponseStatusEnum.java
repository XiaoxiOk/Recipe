...
public enum ResponseStatusEnum {
    ...
    FAILED_NOTIFY(300, false, "操作失败"),

    // 50x
    UN_LOGIN(501,false,"请登录后再继续操作！"),
    TICKET_INVALID(502,false,"会话失效，请重新登录！"),
    TOKEN_TIMEOUT(503,false,"登录信息已过期，请重新登录"),
    LOGIN_FAILED(504,false,"帐户名或密码错误！"),
